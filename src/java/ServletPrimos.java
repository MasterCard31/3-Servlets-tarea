 ...
 * @author carlo
 */
@WebServlet(urlPatterns = {"/ServletPrimos"})
public class ServletPrimos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Obtener el parámetro "n" del usuario
        String nParam = request.getParameter("n");
        int n = Integer.parseInt(nParam);

        // Imprimir los primeros n números primos
        out.println("<html>");
        out.println("<head><title>Primeros " + n + " números primos</title></head>");
        out.println("<body>");
        out.println("<h1>Primeros " + n + " números primos:</h1>");

        int count = 0; // contador de números primos
        int number = 2; // primer número primo
